...
*/
//Now, let's rock!
class DoggyX_Action_DummyTest extends DoggyX_Action_Base implements DoggyX_Action_BeforeInvoke {
    public function before_invoke($invoke_method) {
        pass('before_invoke/'.$invoke_method);
    }
}

$interceptor = new DoggyX_Interceptor_BeforeInvoke();
// $interceptor->init();
