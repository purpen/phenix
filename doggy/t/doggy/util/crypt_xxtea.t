...
*/
//Now, let's rock!
$crypted2 = Doggy_Util_Crypt_XXTEA::encrypt('ABC',md5('1111111111111111AAAA',true));
is(Doggy_Util_Crypt_XXTEA::decrypt($crypted2,md5('1111111111111111AAAA',true)),'ABC','xxtea encrypt/decrypt');
