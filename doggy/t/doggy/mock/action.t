...
*/
//Now, let's rock!
$action = new Doggy_Mock_Action();
is(Doggy_Dispatcher_Constant_Action::NONE,$action->execute(),'execute');
$action = new Doggy_Mock_Action();
is(Doggy_Dispatcher_Constant_Action::NONE,$action->getResultCode(),'getResultCode');
is('a',$action->setResultCode('a')->getResultCode(),'setResultCode');
$action = new Doggy_Mock_Action();
is(Doggy_Dispatcher_Constant_Action::NONE,$action->no_method(),'__call');
?>