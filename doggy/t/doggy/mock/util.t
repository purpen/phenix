...
ok($invocation instanceof Doggy_Mock_ActionInvocation );
ok($invocation->getInvocationContext() instanceof Doggy_Dispatcher_Context);
ok($invocation->getInvocationContext()->getRequest() instanceof Doggy_Mock_Request );
ok($invocation->getInvocationContext()->getResponse() instanceof Doggy_Mock_Response);
