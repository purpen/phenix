...
#model_db
{
    ...
    ok($generator instanceof Doggy_Sequence_DbGenerator,'default db generator');
    is(Doggy_Sequence_Generator::next_id('t1'),1,'next_id');
    is(Doggy_Sequence_Generator::next_id('t1'),2,'next_id');
    Doggy_Sequence_Generator::drop('t1');
    is(Doggy_Sequence_Generator::next_id('t1'),1,'drop');
    Doggy_Sequence_Generator::drop('t1');
}
