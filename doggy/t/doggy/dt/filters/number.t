...
is(Doggy_Dt_Filters_Number::filesize(1024),'1 KB','filesize');
is(Doggy_Dt_Filters_Number::filesize(1024*1024),'1 MB','filesize');


is(Doggy_Dt_Filters_Number::currency(2000,'EUR'),'€2.000,00','currency');
is(Doggy_Dt_Filters_Number::currency(2000),'$2,000.00','currency');
is(Doggy_Dt_Filters_Number::currency(2000,'CNY'),'¥2,000.00','currency');
?>