...
Doggy_Dt_Regex::init();
diag('regex:name=> '.Doggy_Dt_Regex::$name);
diag('regex:operator=> '.Doggy_Dt_Regex::$operator);
diag('regex:i18n=> '.Doggy_Dt_Regex::$i18n_string);
diag('regex:named args=> '.Doggy_Dt_Regex::$named_args);
ok(!empty(Doggy_Dt_Regex::$name) && !empty(Doggy_Dt_Regex::$operator) && !empty(Doggy_Dt_Regex::$i18n_string) && !empty(Doggy_Dt_Regex::$named_args) 
&& !empty(Doggy_Dt_Regex::$number)
);
?>