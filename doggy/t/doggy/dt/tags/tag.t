...
class Doggy_Dt_Tag_Test extends Doggy_Dt_Tag{
    ...
    public function render($context, $stream) {
        $result = $this->resolve_args($context,$this->args);
        $stream->write(json_encode($result));
    }
}

Doggy_Dt::add_tag('test');
is(doggy_dt('{% test "app.welcome","night"  %}')->render(),'["app.welcome","night"]','resolve_args');
is(doggy_dt('{% test "scaler",title:"app.welcome",name:t  %}')->render(array('t'=>array(2,3,4))),'{"0":"scaler","title":"app.welcome","name":[2,3,4]}','resolve_args');
?>