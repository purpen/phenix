...
is(doggy_dt('{% block title %}My Webpage{% endblock %}')->render(),'My Webpage','basic');
is(doggy_dt('{% block header %}{% block title %}title{{block.depth}}{% endblock title%}{% endblock header %}')->render(),'title1','nested block');
?>