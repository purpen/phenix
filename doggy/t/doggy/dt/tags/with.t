...
*/
//Now, let's rock!
Doggy_Dt::add_tag('with');


is(doggy_dt('{% with long_long_name as e %}{{ e }}{% endwith %}')->render(
    array('long_long_name'=> 'e')
    ),'e','with basic');

is(doggy_dt('{% with long_long_name.first.t1 as e %}{{ e.name }}{% endwith %}')->render(
    array('long_long_name'=>array(array('t1'=>array('name'=>'name:t1'))))
    ),'name:t1','with array depth key');
