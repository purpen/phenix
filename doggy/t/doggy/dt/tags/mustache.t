...
*/
//Now, let's rock!
Doggy_Dt::add_tag('mustache','Doggy_Dt_Tag_MustacheTemplate');
...
$result = doggy_dt(
    '{%mustache tpl:"t1" id:"mustache1" %}',$option)->render();
is($result,"<script id='mustache1' type='text/template'>\n{{#user}}{{v}}{{/user}}\n</script>",'render mustache tpl source');
?>