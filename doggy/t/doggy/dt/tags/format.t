...
*/
//Now, let's rock!
Doggy_Dt::add_tag('format');
Doggy_Config::$vars['app.welcome'] = 'welcome %s';
is(doggy_dt('{% format "app.welcome","night"  %}')->render(),'welcome night','basic');
is(doggy_dt('{% format "your name is %s","night"  %}')->render(),'your name is night','fallback to plain');
Doggy_Config::$vars['app.welcome_title'] = 'welcome %s %s';
is(doggy_dt('{% format "app.welcome_title",title,name  %}')->render(array('name'=>'night','title'=>'Mr.')),'welcome Mr. night','vars');
?>