...
if (ini_get('apc.enable_cli') != '1') {
    plan('skip_all','apc.enable_cli not set to true,skip');
}
$cache = new Doggy_Dt_Cache_Apc();
$cache->write('page1.html',array('filename'=>'page1.html','content'=>'hello'));
is($cache->read('page1.html'),array('filename'=>'page1.html','content'=>'hello'));
?>