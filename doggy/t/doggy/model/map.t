...
*/
//Now, let's rock!
Doggy_Config::$vars['app.model.test.map'] = array(
    'class'=>'Doggy_Model_IdentifyMap_Memcached',
    'cache_id'=>'model_map',
    );

$map = Doggy_Model_IdentifyMap::get_map('test');
ok($map instanceof Doggy_Model_IdentifyMap_Memcached,'get_map');
is(Doggy_Model_IdentifyMap::get_map('no_defined_model'),false,'get_map undefined');
?>