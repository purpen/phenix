...
$cache = Doggy_Cache_Manager::get_cache();
ok($cache instanceof Doggy_Cache_Provider,'get_cache default');

Doggy_Cache_Manager::set('k1','k1');
is(Doggy_Cache_Manager::get('k1'),'k1','set/get');
Doggy_Cache_Manager::remove('k1');
cmp_ok(Doggy_Cache_Manager::get('k1'),'===',null,'remove');

Doggy_Cache_Manager::set('k2','k2');
Doggy_Cache_Manager::clear();

cmp_ok(Doggy_Cache_Manager::get('k2'),'===',null,'remove');
