...
{
    $dba = Doggy_Dba_Manager::getDefaultConnection();
    ok($dba instanceof Doggy_Dba_Adapter, 'get_default_connection');
    $dba2 = Doggy_Dba_Manager::get_dba('default');
    $dba3 = Doggy_Dba_Manager::get_dba('fallback');
    ok($dba2 instanceof Doggy_Dba_Adapter, 'get_dba');
    ok($dba3 instanceof Doggy_Dba_Adapter, 'get_default_connection(fallback)');
}
{
    $model_dba = Doggy_Dba_Manager::get_model_dba();
    ok($model_dba instanceof Doggy_Dba_Adapter, 'get_model_dba');
}
