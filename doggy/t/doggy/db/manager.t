...

{
    ...
    ok($db instanceof Doggy_Db_Driver, 'get_db');
    $db2 = Doggy_Db_Manager::get_db('default');
    $db3 = Doggy_Db_Manager::get_db('fallback');
    ok($db2 instanceof Doggy_Db_Driver, 'get_db');
    ok($db3 instanceof Doggy_Db_Driver, 'get_db(fallback)');
}
?>