...
$action->stash['_json']['t'] = 'test';
$respone= $context->getResponse();
$result = new Doggy_Dispatcher_Result_Json();
$result->execute($invocation);
$json_s = '{"errorCode":null,"errorMessage":null,"hasError":false,"data":{"t":"test"}}';
is($respone->getBuffer(),$json_s,'json result');
?>