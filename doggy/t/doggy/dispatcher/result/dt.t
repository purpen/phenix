...
file_put_contents($dir.'/test.html',$test_tpl);

$dt_options['templates_dir'] = $dir;
// Doggy_Config::set('app.dt',$dt_options);
...
$result = new Doggy_Dispatcher_Result_Dt();
$context->putResult('template','should_not_exists.html');
try{
...
$context->putResult('template','test.html');
$result->execute($invocation);
is($respone->getBuffer(),$test_content,'dt result,render');
