...
$data = '<html><body>AAA</body></html>';
$context->putResult('data',$data);
$context->putResult('content_type','text/html');
$invocation = new Doggy_Mock_ActionInvocation($context,null,null);
$invocation->setAction(new Doggy_Mock_Action());

$result = new Doggy_Dispatcher_Result_Raw();
$result->execute($invocation);
is($result->getBuffer(),$data,'raw result data');
is($context->getResponse()->getContentType(),'text/html; charset=utf-8','raw result data');
?>