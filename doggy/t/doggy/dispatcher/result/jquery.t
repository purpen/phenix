...
$context->putResult('template','test.jquery.test');
$context->put('ok','123');
$result = new Doggy_Dispatcher_Result_JQuery();
$result->execute($invocation);

$respone= $context->getResponse();
is($respone->getContentType(),"text/xml; charset=utf-8",'jquery result');
is($respone->getBuffer(),"<taconite>\n123</taconite>",'jquery result');
?>