...
is($mapping->getNamespace(),$namespace,'set/get namespace');
$params= array('test'=>'1','user'=>'foo');
$mapping->setParams($params);
is($mapping->getParams(),$params,'set/get params');
$name='doggy_action';
$mapping->setName($name);
is($mapping->getName(),$name,'set/get name');
$method='doIt';
$mapping->setMethod($method);
is($mapping->getMethod(),$method,'set/get method');
?>