...
*/
//Now, let's rock!
class ModelDrivenTestMockAction extends Doggy_Dispatcher_Action_ModelDriven {
    protected $modelClass='ModelDrivenTestMockModel';
    public function wiredModel(){
        return parent::wiredModel();
    }
    
}
class ModelDrivenTestMockModel extends Doggy_ActiveRecord_Base{
    public function __construct(){
    }
     
}
$action = new ModelDrivenTestMockAction();
$model = $action->wiredModel();
ok(!is_null($model),'wiredModel');
ok($model instanceof ModelDrivenTestMockModel,'wiredModel');
