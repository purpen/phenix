...
Doggy_Config::$vars['app.dhash.default'] = array('class'=>'Doggy_DHash_Flare');
Doggy_Config::$vars['app.dhash.redis'] = array('class'=>'Doggy_DHash_Redis');

ok(Doggy_DHash_Manager::hash() instanceof Doggy_DHash_Flare,'default dhash');
ok(Doggy_DHash_Manager::hash('unkown_hash_id') instanceof Doggy_DHash_Flare,'fallback dhash');
ok(Doggy_DHash_Manager::hash('redis') instanceof Doggy_DHash_Redis,'dhash id');
