<?php
class ServiceDetailProviderFindServiceDetailRequest
{
	...
	public function getAfsServiceId(){
	  return $this->afsServiceId;
                                            		                                    	                   	                    		...
                                            		                                    	                   	                    		private $appendInfoStep;
    	                        
	public function setAppendInfoStep($appendInfoStep){
		$this->appendInfoStep = $appendInfoStep;
         $this->apiParas["appendInfoStep"] = $appendInfoStep;
	}

	public function getAppendInfoStep(){
