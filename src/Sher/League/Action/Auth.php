 ...
 * @author tianshuai
 */
class Sher_League_Action_Auth extends Sher_League_Action_Base {
    ...
    $this->stash['wx_params'] = $wx_params;
		...
		return $this->to_html_page('league/auth/login.html');
	}
    ...
    $this->stash['wx_params'] = $wx_params;
		...
		return $this->to_html_page('league/auth/signup.html');
	}
