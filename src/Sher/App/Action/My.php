...
class Sher_App_Action_My extends Sher_App_Action_Base implements DoggyX_Action_Initialize {
  ...
  public function bind_phone() {
	...
	$callback = Doggy_Config::$vars['app.url.my'].'/bind_account/bind_sina_account';
    ...
    $wx_params = array(
      ...
      'redirect_uri' => $redirect_uri = urlencode(Doggy_Config::$vars['app.url.my'].'/bind_account/bind_wechat_account'),
      'state' => md5($sid),
    );
