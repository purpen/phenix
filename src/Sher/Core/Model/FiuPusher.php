  ...
  const FROM_IPAD = 4;
	...
	public function binding($uuid, $user_id, $from_to, $channel=0){
        ...
        if($pusher){
          ...
          // 首次绑定送红包
          if($ok){
            Sher_Core_Util_Shopping::give_bonus((int)$user_id, array('count'=>10, 'xname'=>'DA100', 'bonus'=>'B', 'min_amounts'=>'G'));
            Sher_Core_Util_Shopping::give_bonus((int)$user_id, array('count'=>10, 'xname'=>'DA50', 'bonus'=>'A', 'min_amounts'=>'H'));
            Sher_Core_Util_Shopping::give_bonus((int)$user_id, array('count'=>10, 'xname'=>'DA30', 'bonus'=>'C', 'min_amounts'=>'D'));
            Sher_Core_Util_Shopping::give_bonus((int)$user_id, array('count'=>10, 'xname'=>'DA20', 'bonus'=>'I', 'min_amounts'=>'B'));
