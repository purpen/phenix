 ...
 * @author tianshuai
 */
class Sher_Core_ViewTag_ReportTipList extends Doggy_Dt_Tag {
    protected $argstring;
    ...
    $load_item = 0;
        ...
        $service = Sher_Core_Service_ReportTip::instance();
        $options['page'] = $page;
        $options['size'] = $size;
		$options['sort_field'] = $sort_field;
        $result = $service->get_report_tip_list($query,$options);
