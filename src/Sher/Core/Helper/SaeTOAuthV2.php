 ...
 * @version 1.0
 */
class Sher_Core_Helper_SaeTOAuthV2 {
	/**
	 * @ignore
	 */
	public $client_id;
	...
	function getAccessToken( $type = 'code', $keys ) {
		...
		if ( $type === 'token' ) {
			...
			throw new Sher_Core_Helper_OAuthException("wrong auth type");
		}
		...
		if ( is_array($token) && !isset($token['error']) ) {
			...
			throw new Sher_Core_Helper_OAuthException("get access token failed." . $token['error']);
		}
		return $token;
	}
