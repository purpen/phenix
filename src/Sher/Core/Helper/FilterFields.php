...
class Sher_Core_Helper_FilterFields {
  ...
  public static function wap_user($user){
    $some_fields = array('_id'=>1,'account'=>1,'nickname'=>1,'true_nickname'=>1,'state'=>1,'first_login'=>1,'profile'=>1,'city'=>1,'sex'=>1,'summary'=>1,'created_on'=>1,'email'=>1,'birthday'=>1,'medium_avatar_url'=>1, 'im_qq'=>1, 'weixin'=>1, 'identify'=>1,);
		// 重建数据结果
		$data = array();
