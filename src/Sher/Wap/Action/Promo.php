...
class Sher_Wap_Action_Promo extends Sher_Wap_Action_Base {
    ...
    public function cyj(){
        ...
        return $this->to_html_page('wap/promo/cyj.html');    
    }
   ...
   */
   ...
   public function d3in_hi(){
    // 记录浏览数
	  ...
	  $num_mode->add_record('28', 'view_count', 4, 4); 
       ...
       $wxOri = sprintf("jsapi_ticket=%s&noncestr=%s&timestamp=%s&url=%s", $wxticket, $wxnonceStr, $timestamp, $url);
       $this->stash['wxSha1'] = sha1($wxOri);
       return $this->to_html_page('wap/promo/d3in_hi.html');
   }
    ...
    */
      ...
      public function red_details(){
        return $this->to_html_page('wap/promo/red_details.html');
      }
}
