...
class Sher_Wap_Action_Index extends Sher_Wap_Action_Base {
	...
	protected $exclude_method_list = array('execute','home','twelve','comeon','games','clients','fiu','qr','fiu_download','surl','d3in_newer','service');
    ...
    public function fiu_download(){
        $url = "https://frstatic.qiniudn.com/download/app-release_1.9.3.apk";
