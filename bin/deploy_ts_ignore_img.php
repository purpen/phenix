...
function inc_version($css_version, $js_version, $to_src){
  ...
  //未加版本号 javascript/calendar.js, javascript/jquery.flexslider.js
	$js_files = array('javascript/base.min.js', 'javascript/jquery.plugins.min.js', 'javascript/frbird.min.js', 'javascript/froala_editor.min.js', 'javascript/jquery.taconite.min.js', 'javascript/mobile.min.js');
